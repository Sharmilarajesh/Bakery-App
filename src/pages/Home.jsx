...
const categories = [
  { 
    ...
    color: "bg-gradient-to-b from-pink-50 to-rose-50",
    icon: "🎂"
  },
  { 
    name: "Cookies", 
    ...
    color: "bg-gradient-to-b from-amber-50 to-orange-50",
    icon: "🍪"
  },
  { 
    name: "Breads", 
    ...
    color: "bg-gradient-to-b from-yellow-50 to-amber-50",
    icon: "🍞"
  },
  { 
    name: "Muffins", 
    ...
    color: "bg-gradient-to-b from-violet-50 to-purple-50",
    icon: "🧁"
  },
];
